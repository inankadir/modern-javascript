...
//Bean counting : You can get the Nth character, or letter, from a string by writing "string"[N].
//The returned value will be a string containing only one character (for example, "b"). The first 
//character has position 0, which causes the last one to be found at position string.length - 1. 
